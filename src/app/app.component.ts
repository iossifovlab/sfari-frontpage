...
export class AppComponent implements OnInit {
  ...
  public login(): void {
    ...
    window.open(`${environment.authPath}/o/authorize/?response_type=code&code_challenge_method=S256&code_challenge=${codeChallenge}&client_id=${environment.oauthClientId}`,
